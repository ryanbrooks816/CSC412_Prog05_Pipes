...
void Server::verifyDataFilesDistribution(const std::vector<std::string> &files)
{
    ...
    for (int i = 0; i < this->numClients; i++)
    {
        ...
        if (pid == 0)
        {
            ...
            args[0] = const_cast<char *>("./Executables/distributeData");
            ...
            execvp("./Executables/distributeData", args.data());
...
std::string Server::processDataFiles()
{
    ...
    for (int i = 0; i < this->numClients; i++)
    {
        ...
        if (pid == 0)
        {
            ...
            args[0] = "./Executables/processData";
            ...
            execvp("./Executables/processData", c_args.data());
